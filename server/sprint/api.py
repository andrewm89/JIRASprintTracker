...
@app.route('/sprint/boards', methods=['GET'])
def get_boards():
...
@app.route('/sprint/sprints/<board_id>', methods=['GET'])
...
@app.route('/sprint/sprints/db', methods=['GET'])
def get_sprints_from_db():
    try:
        sprints = []
...
@app.route('/sprint/sprints/db/<path:name>', methods=['GET'])
...
@app.route('/sprint/sprints/new', methods=['POST'])
def new_sprint():
    try:
...
@app.route('/sprint/sprints', methods=['PUT'])
def update_sprints():
    try:
